...
export function ApiCard({ apiToken }: { apiToken: string | null }) {
  ...
  return (
    <div className="grid gap-4">
      <div>
        <div className="mb-1 flex items-center gap-2 font-medium"><FileSpreadsheet className="size-4 text-primary" />Excel de la RAF branché sur l'outil</div>
      ...
      <div>
        ...
        <p className="mb-2 text-sm text-muted-foreground">Les actions cochées « Public » dans les éditions en cours, en flux iCal sans jeton : n'importe quel module agenda WordPress l'affiche.</p>

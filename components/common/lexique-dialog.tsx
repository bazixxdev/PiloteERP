  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-2xl" data-testid="lexique">
        <DialogHeader><DialogTitle>Lexique</DialogTitle><DialogDescription>Ce que chaque mot veut dire dans l&apos;outil. Vocabulaire à valider avec {le(V.org)} (question 1 du cahier des charges).</DialogDescription></DialogHeader>

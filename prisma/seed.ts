...
async function main() {
  ...
  // ─────────────────────────────────────────────────────────────────────────────────────────────
  const note = (authorId: string, title: string, context: string, visibility: string, day: string, body: string, editionId: string | null = null) => prisma.note.create({ data: { authorId, title, context, visibility, date: dayjs(day).toDate(), body, editionId } });

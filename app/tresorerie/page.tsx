    ...
    <div className="p-4 md:p-6">
      ...
      <div className="mb-4 overflow-x-auto rounded-md border bg-card">
        <table className="w-full text-[12px]" data-testid="treasury-table">
          ...
          <tbody className="divide-y">
            ...
            {outRows.length === 0 && <tr><td colSpan={plan.months.length + 2} className="px-3 py-2 text-muted-foreground">Aucun décaissement prévu : ajoutez les charges (salaires, loyer…).</td></tr>}
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <section className="rounded-md border bg-card" data-testid="treasury-rules">
          <div className="flex items-start justify-between gap-2 px-4 pb-2 pt-3"><div><h2 className="text-[15px] font-bold">Charges et recettes saisies</h2><p className="text-[11px] text-muted-foreground">Ce qui ne se déduit pas des dossiers : salaires et charges, loyer, leasing, subvention de fonctionnement, prestations… Chaque ligne a un premier mois (et un dernier, si ça s&apos;arrête) : une embauche en mars, un leasing dès février se posent ici. Décochée, une ligne sort du plan sans disparaître.</p></div></div>

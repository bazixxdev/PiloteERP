...
export default async function ValidationsPage({ searchParams }: { searchParams: Promise<{ niveau?: string; perimetre?: string }> }) {
  ...
  return (
    <div className="p-4 md:p-6">
      ...
      <Section title={isTransversal(me) || perimeter === "cress" ? "Toute la CRESS · file par valideur" : `Mon pôle · file par valideur`} description="Pour information : toutes les demandes en attente du périmètre choisi, les plus anciennes en premier. Ce ne sont pas vos tâches, sauf celles reprises dans « À traiter par moi »." className="mb-4">

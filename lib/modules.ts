...
export const INSTANCE_MODULES = [
  ...
  { key: "delegation", label: "Délégations", hint: `Ce que ${le(V.direction)} délègue à une personne sur ses ${V.projet.many} : attendus, limites, contrôles, prise de connaissance, présentation ; la vue reprend ses ${V.action.many}, indicateurs et livrables. Rubrique « Ma délégation ».` },
] as const;
